...
export const tools = [
  ...
  },
  {
    ...
    category: 'image',
    description: 'Convert Apple HEIC photos to universal JPG format online instantly',
    icon: Image,
    popular: true,
    features: ['Browser-based processing', 'Batch HEIC conversion', 'Privacy guaranteed'],
    path: '/tools/image-converter/heic-to-jpg',
    tags: ['heic', 'jpg', 'convert', 'apple', 'photo']
  },
  {
    id: 'heic-to-png',
    name: 'HEIC to PNG Converter',
    category: 'image',
    description: 'Convert Apple HEIC photos to lossless PNG format with transparency online',
    icon: Image,
    features: ['Browser-based processing', 'Lossless conversion', 'Batch support'],
    path: '/tools/image-converter/heic-to-png',
    tags: ['heic', 'png', 'convert', 'apple', 'photo', 'lossless']
  },
  {
    id: 'heic-image-viewer',
    name: 'HEIC Image Viewer',
    category: 'image',
    description: 'View HEIC, AVIF, WebP, and other unsupported images directly in your browser',
    icon: Eye,
    popular: true,
    features: ['Browser-based viewing', 'Lossless decode', 'Gallery mode'],
    path: '/tools/heic-image-viewer',
    tags: ['heic', 'viewer', 'avif', 'webp', 'image']
  },
  {
    id: 'image-compressor',
  ...
  {
    id: 'est-to-pst-converter',
    name: 'EST to PST Converter',
    category: 'datetime',
    description: 'Instantly convert Eastern Standard Time (EST) to Pacific Standard Time (PST)',
    icon: Clock,
    features: ['EST to PST', 'Live time tracking', 'Instant conversion'],
    path: '/tools/timezone-converter/est-to-pst',
    tags: ['est', 'pst', 'time', 'convert', 'timezone']
  },
  {
    id: 'pst-to-est-converter',
    name: 'PST to EST Converter',
    category: 'datetime',
    description: 'Instantly convert Pacific Standard Time (PST) to Eastern Standard Time (EST)',
    icon: Clock,
    features: ['PST to EST', 'Live time tracking', 'Instant conversion'],
    path: '/tools/timezone-converter/pst-to-est',
    tags: ['pst', 'est', 'time', 'convert', 'timezone']
  },
  {
  ...
  },
  {
    ...
    category: 'file',
    description: 'Convert PowerPoint presentations to pixel-perfect PDF documents',
    icon: FileSignature,
    features: ['PPT & PPTX support', 'Pixel-perfect slides', 'Vector PDF output', 'Secure processing'],
    path: '/tools/ppt-to-pdf',
    tags: ['powerpoint', 'ppt', 'pptx', 'pdf', 'presentation', 'convert', 'slides']
  },
  {
    id: 'pdf-to-excel',
    name: 'PDF to Excel',
