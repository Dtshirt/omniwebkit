...
export const tools = [
  ...
  },
  {
    ...
    icon: Image,
    popular: true,
    features: ['image extraction', 'Bulk download', 'Format options', 'Export options'],
    path: '/tools/website-image-downloader',
    tags: ['images', 'download', 'bulk', 'website']
  },
  {
  ...
  },
  {
    ...
    category: 'seo',
    description: 'Perform complete on-page SEO audits for any webpage',
    icon: Globe,
    popular: true,
    features: ['Meta audit', 'Header analysis', 'Image alt check'],
    path: '/tools/seo-analyzer',
    tags: ['seo', 'audit', 'analyzer', 'on-page']
  },
  {
