    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-2">JPG to PNG Converter</h1>
          <p className="text-slate-600 dark:text-slate-400 text-lg">Convert JPG images to high-quality, lossless PNG format.</p>
