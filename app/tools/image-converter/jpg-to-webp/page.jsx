    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-2">JPG to WebP Converter</h1>
          <p className="text-slate-600 dark:text-slate-400 text-lg">Convert JPG images to the modern, highly compressed WebP format.</p>
          ...
          <div className="lg:col-span-2">
            <div className={`${cardCls} overflow-hidden flex flex-col h-full min-h-[400px]`}>
              ...
              <div
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1">{fileDrag ? 'Drop JPGs here!' : 'Upload JPG Images'}</h3>
