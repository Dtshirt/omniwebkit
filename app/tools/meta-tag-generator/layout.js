...
const toolSeo = seoData['meta-tag-generator'];
...
export default function MetaTagGeneratorLayout({ children }) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
        ...
        <RelatedTools currentTool="meta-tag-generator" category="seo" />
      </div>
    </>
  );
}
